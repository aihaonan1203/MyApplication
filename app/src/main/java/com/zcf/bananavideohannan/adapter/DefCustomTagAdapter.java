...
public class DefCustomTagAdapter extends BaseAdapter {
    private Context mContext;
    private List<ZltjTjResultBean.DataBean.ValueBean> data;

    public DefCustomTagAdapter(Context mContext, List<ZltjTjResultBean.DataBean.ValueBean> data) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        final ZltjTjResultBean.DataBean.ValueBean model = data.get(i);
        if (model != null) {
    ...
    public void setData(List<ZltjTjResultBean.DataBean.ValueBean> data) {
        if (data == null) {
            data = new ArrayList<>();
        }
        this.data = data;
