...
@ContentView(R.layout.fragment_playhistory_seven)
public class PlayHistprySevenFragment extends MyBaseFragment {
    @ViewInject(R.id.lv_ph_seven)
    private ListView lv_ph_seven;
    ...
    @SuppressLint("ValidFragment")
    public PlayHistprySevenFragment(List<LishiBean> data) {
        this.data = data;
    }
    ...
    private void initAdapter() {
        ...
        lv_ph_seven.setAdapter(adapter);
    }
}
