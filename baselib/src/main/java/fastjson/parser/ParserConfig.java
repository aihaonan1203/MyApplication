...
import fastjson.annotation.JSONType;
import fastjson.parser.deserializer.ArrayDeserializer;
import fastjson.parser.deserializer.ArrayListTypeFieldDeserializer;
import fastjson.parser.deserializer.BigDecimalDeserializer;
import fastjson.parser.deserializer.BigIntegerDeserializer;
import fastjson.parser.deserializer.BooleanDeserializer;
import fastjson.parser.deserializer.BooleanFieldDeserializer;
import fastjson.parser.deserializer.CalendarDeserializer;
import fastjson.parser.deserializer.CharArrayDeserializer;
import fastjson.parser.deserializer.CharacterDeserializer;
import fastjson.parser.deserializer.CharsetDeserializer;
import fastjson.parser.deserializer.ClassDerializer;
import fastjson.parser.deserializer.CollectionDeserializer;
import fastjson.parser.deserializer.DateDeserializer;
import fastjson.parser.deserializer.DateFormatDeserializer;
import fastjson.parser.deserializer.DefaultFieldDeserializer;
import fastjson.parser.deserializer.EnumDeserializer;
import fastjson.parser.deserializer.FieldDeserializer;
import fastjson.parser.deserializer.FileDeserializer;
import fastjson.parser.deserializer.FloatDeserializer;
import fastjson.parser.deserializer.InetAddressDeserializer;
import fastjson.parser.deserializer.InetSocketAddressDeserializer;
import fastjson.parser.deserializer.IntegerDeserializer;
import fastjson.parser.deserializer.IntegerFieldDeserializer;
import fastjson.parser.deserializer.JSONArrayDeserializer;
import fastjson.parser.deserializer.JSONObjectDeserializer;
import fastjson.parser.deserializer.JavaBeanDeserializer;
import fastjson.parser.deserializer.JavaObjectDeserializer;
import fastjson.parser.deserializer.LocaleDeserializer;
import fastjson.parser.deserializer.LongDeserializer;
import fastjson.parser.deserializer.LongFieldDeserializer;
import fastjson.parser.deserializer.MapDeserializer;
import fastjson.parser.deserializer.NumberDeserializer;
import fastjson.parser.deserializer.ObjectDeserializer;
import fastjson.parser.deserializer.PatternDeserializer;
import fastjson.parser.deserializer.ReferenceDeserializer;
import fastjson.parser.deserializer.SqlDateDeserializer;
import fastjson.parser.deserializer.StackTraceElementDeserializer;
import fastjson.parser.deserializer.StringDeserializer;
import fastjson.parser.deserializer.StringFieldDeserializer;
import fastjson.parser.deserializer.ThrowableDeserializer;
import fastjson.parser.deserializer.TimeDeserializer;
import fastjson.parser.deserializer.TimeZoneDeserializer;
import fastjson.parser.deserializer.TimestampDeserializer;
import fastjson.parser.deserializer.URIDeserializer;
import fastjson.parser.deserializer.URLDeserializer;
import fastjson.parser.deserializer.UUIDDeserializer;
import fastjson.util.FieldInfo;
import fastjson.util.IdentityHashMap;
