...
import fastjson.parser.Feature;
import fastjson.parser.JSONLexer;
import fastjson.parser.JSONToken;
import fastjson.parser.ParserConfig;
import fastjson.parser.DefaultJSONParser.ResolveTask;
import fastjson.parser.deserializer.FieldDeserializer;
import fastjson.serializer.JSONSerializer;
import fastjson.serializer.NameFilter;
import fastjson.serializer.PropertyFilter;
import fastjson.serializer.PropertyPreFilter;
import fastjson.serializer.SerializeConfig;
import fastjson.serializer.SerializeFilter;
import fastjson.serializer.SerializeWriter;
import fastjson.serializer.SerializerFeature;
import fastjson.serializer.ValueFilter;
import fastjson.util.FieldInfo;
import fastjson.util.IOUtils;
import fastjson.util.ThreadLocalCache;
...
public abstract class JSON implements JSONStreamAware, JSONAware {
    ...
    static {
        int features = 0;
        features |= fastjson.serializer.SerializerFeature.QuoteFieldNames.getMask();
        features |= fastjson.serializer.SerializerFeature.SkipTransientField.getMask();
        features |= fastjson.serializer.SerializerFeature.WriteEnumUsingToString.getMask();
        features |= fastjson.serializer.SerializerFeature.SortField.getMask();
        // features |=
    ...
    public static final String toJSONString(Object object, SerializerFeature... features) {
        ...
        try {
            ...
            for (fastjson.serializer.SerializerFeature feature : features) {
