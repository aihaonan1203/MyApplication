 ...
 * 自动生成dimen 文件
 */
public class GenerateValueFilesUtils {
	...
	public GenerateValueFilesUtils(int baseX, int baseY, String supportStr) {
		this.baseW = baseX;
		this.baseH = baseY;
	...
	public static void main(String[] args) {
		...
		new GenerateValueFilesUtils(baseW, baseH, addition).generate();
	}
