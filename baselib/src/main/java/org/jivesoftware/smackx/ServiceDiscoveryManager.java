...
public class ServiceDiscoveryManager {
    ...
    private static List<Identity> identities = new LinkedList<Identity>();
    ...
    public static void setIdentityName(String name) {
        Identity identity = identities.remove(0);
        identity = new Identity(DEFAULT_IDENTITY_CATEGORY, name, DEFAULT_IDENTITY_TYPE);
    ...
    public static void setIdentityType(String type) {
        ...
        if (identity != null) {
            ...
            identity = new Identity(DEFAULT_IDENTITY_CATEGORY, DEFAULT_IDENTITY_NAME, type);
            identities.add(identity);
        }
    }
