package fm.jiecao.jcvideoplayer_lib.jcvideoplayer_two;
...
public class JCMediaManager implements TextureView.SurfaceTextureListener, MediaPlayer.OnPreparedListener, MediaPlayer.OnCompletionListener, MediaPlayer.OnBufferingUpdateListener, MediaPlayer.OnSeekCompleteListener, MediaPlayer.OnErrorListener, MediaPlayer.OnInfoListener, MediaPlayer.OnVideoSizeChangedListener {
    ...
    private static fm.jiecao.jcvideoplayer_lib.jcvideoplayer_two.JCMediaManager JCMediaManager;
    ...
    public static fm.jiecao.jcvideoplayer_lib.jcvideoplayer_two.JCMediaManager instance() {
            ...
            switch (msg.what) {
                case HANDLER_PREPARE:
                    try {
                        ...
                        mediaPlayer.setOnPreparedListener(fm.jiecao.jcvideoplayer_lib.jcvideoplayer_two.JCMediaManager.this);
                        mediaPlayer.setOnCompletionListener(fm.jiecao.jcvideoplayer_lib.jcvideoplayer_two.JCMediaManager.this);
                        mediaPlayer.setOnBufferingUpdateListener(fm.jiecao.jcvideoplayer_lib.jcvideoplayer_two.JCMediaManager.this);
                        mediaPlayer.setScreenOnWhilePlaying(true);
                        mediaPlayer.setOnSeekCompleteListener(fm.jiecao.jcvideoplayer_lib.jcvideoplayer_two.JCMediaManager.this);
                        mediaPlayer.setOnErrorListener(fm.jiecao.jcvideoplayer_lib.jcvideoplayer_two.JCMediaManager.this);
                        mediaPlayer.setOnInfoListener(fm.jiecao.jcvideoplayer_lib.jcvideoplayer_two.JCMediaManager.this);
                        mediaPlayer.setOnVideoSizeChangedListener(fm.jiecao.jcvideoplayer_lib.jcvideoplayer_two.JCMediaManager.this);
